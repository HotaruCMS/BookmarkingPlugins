...
Changelog
---------
-  v.1.5 2014/10/15 - shibuya246 - Remove deprecated method
 - v.1.4 2010/11/30 - George - Fixed bug that prevented the deletion of user and bug that showed wrong message when deleting a user.
 - v.1.3 2010/11/11 - Nick - Removed SITEID usage from content pending filter
 - v.1.2 2010/08/13 - Nick - Added ability to create and remove custom usergroups - shibuya246 - Added a "Content Pending" filter
 - v.1.1 2010/07/30 - Nick - Added user's IP address
 - v.1.0 2010/05/27 - Nick - Added "check all" checkbox
 ...
 - v.0.4 2009/11/26 - Nick - Bug fixes for changing user roles
