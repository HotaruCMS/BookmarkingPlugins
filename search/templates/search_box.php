...
<div class="widget_body search_box">
    <form role="form" name='search_form' id='search_form' action='<?php echo BASEURL; ?>index.php?page=search' method='get'> 
        
            <div class="input-group">
                
                <input id="search_input" type="text" class="form-control" value="<?php echo $h->lang['search_text'];  ?>" name="search" 
