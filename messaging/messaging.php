 ...
 * class: Messaging
 * requires: users 1.5
 * hooks: install_plugin, theme_index_top, header_include, profile_navigation, profile_action_buttons, breadcrumbs, theme_index_main, admin_maintenance_database, admin_maintenance_top, user_settings_pre_save, user_settings_fill_form, user_settings_extra_settings, userauth_checkcookie_success, hotaru_announcements
 * author: Nick Ramsay
